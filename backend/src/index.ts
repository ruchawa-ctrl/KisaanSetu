...
import authRoutes from './routes/auth'; import lotRoutes from './routes/lots'; import fpoRoutes from './routes/fpo'; import demandRoutes from './routes/demands'; import transactionRoutes from './routes/transactions';
...
app.use('/api/v1/auth', authRoutes); app.use('/api/v1/lots', lotRoutes); app.use('/api/v1/fpo', fpoRoutes); app.use('/api/v1/demands', demandRoutes); app.use('/api/v1/transactions', transactionRoutes);
